 ...
 */
@NonNullByDefault
public class VWCarNetSmartLockJSON extends VWCarNetAlarmJSON {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof VWCarNetSmartLockJSON)) {
            return false;
        }
        VWCarNetSmartLockJSON other = (VWCarNetSmartLockJSON) obj;
